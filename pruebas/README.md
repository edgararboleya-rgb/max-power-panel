...
| `e13.js` | E13a · las cotizaciones del proveedor no pagan misceláneas, y E13e · MXP MEP calcula con sus propias tarifas, overhead y sales tax. Lo primero que comprueba es que **ningún estimado que ya existe se mueva ni un centavo**: una línea sin marcar da el bid idéntico al de la fórmula vieja. |
